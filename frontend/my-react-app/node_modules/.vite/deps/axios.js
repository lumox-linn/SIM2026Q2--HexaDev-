	...
	xhr: typeof XMLHttpRequest !== "undefined" && function(config) {
		return new Promise(function dispatchXhrRequest(resolve, reject) {
			...
			if (utils_default.isFormData(requestData)) {
				if (browser_default.isStandardBrowserEnv || browser_default.isStandardBrowserWebWorkerEnv) requestHeaders.setContentType(false);
				else if (!requestHeaders.getContentType(/^\s*multipart\/form-data/)) requestHeaders.setContentType("multipart/form-data");
				else if (utils_default.isString(contentType = requestHeaders.getContentType())) requestHeaders.setContentType(contentType.replace(/^\s*(multipart\/form-data);+/, "$1"));
			}
