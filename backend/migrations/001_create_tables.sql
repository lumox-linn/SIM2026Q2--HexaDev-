...
-- Add profile_picture column to useraccount
-- Stores the filename only (e.g. "abc123.jpg")
-- Full URL is generated by the backend on request
ALTER TABLE `useraccount`
  ADD COLUMN `profile_picture` VARCHAR(255) DEFAULT NULL;

-- Add email column to useraccount
ALTER TABLE `useraccount`
  ADD COLUMN `email` VARCHAR(100) DEFAULT NULL,
  ADD UNIQUE KEY `email` (`email`);

-- Add dob column to useraccount
ALTER TABLE `useraccount`
